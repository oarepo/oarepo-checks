...
Report bugs at <https://github.com/oarepo/oarepo-checks/issues>.
...
<https://github.com/oarepo/oarepo-checks/issues>.
...
Ready to contribute? Here's how to set up `oarepo-checks` for local
development.

1. Fork the `oarepo/oarepo-checks` repo on GitHub.

2. Clone your fork locally:

   ```console
   git clone git@github.com:your_name_here/oarepo-checks.git
   ```
